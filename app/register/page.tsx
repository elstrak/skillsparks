      ...
      <div className="w-full max-w-md">
        <div className="mx-auto text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            ...
            <Link href="/login" className="text-accent-purple font-medium hover:text-accent-purple/90">
              Войти
            </Link>
          </p>
        </div>
          ...
          <form className="space-y-6" action="#" method="POST">
            ...
            <div className="flex items-start">
              ...
              <Label htmlFor="terms" className="ml-2 text-sm">
                Я согласен с{" "}
                <Link href="/terms" className="text-accent-purple hover:text-accent-purple/90">
                  условиями использования
                </Link>{" "}
                и{" "}
                <Link href="/privacy" className="text-accent-purple hover:text-accent-purple/90">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-card text-gray-500">Или зарегистрируйтесь через</span>
              </div>
            </div>
